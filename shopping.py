...
def load_data(filename):
    ...
    visitorTypes = dict(Returning_Visitor=1, New_Visitor=0, Other=0)
...
def evaluate(labels, predictions):
    ...
    sensitivity = identified_positive / actually_positive
    specificity = identified_negative / actually_negative
